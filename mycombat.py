...
if len(params) == 2:
    try:
        ...
        # criação o shape do tanque comunistaz
    ...
    error = "fewer then" if len(params) < 2 else "above"
    print("Number of params {} expected".format(error)) 